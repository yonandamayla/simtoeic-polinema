            ...
            <div class="section-body">
                ...
                @if ($user->exam_status == 'on_process')
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        ...
                        <strong>TOEIC Status:</strong> Your exam registration is currently being processed. You will be
                        notified when
                                ...
                                @if ($announcements)
                                    <div class="announcement-container">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <h4 class="text-primary mb-0" style="font-size: 20px;">
                                        ...
                                        <div class="announcement-content p-3 bg-light rounded">
                                            <p class="mb-0" style="font-size: 19px; font-weight: bold;">
                                        ...
                                        @if ($announcements->photo)
                                            <div class="pdf-attachment mt-3 p-3 border rounded bg-white">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div class="d-flex align-items-center">
                                                        <i class="fas fa-file-image text-danger mr-3"
                                                            style="font-size: 2rem;"></i>
                                                        <div>
                            ...
                            <div class="card-header bg-light d-flex align-items-center justify-content-between py-3">
                                ...
                                <div class="d-flex align-items-center">
                                    @if (count($allExamScores) > 0)
                                        <span class="badge badge-primary mr-2">{{ count($allExamScores) }} Results</span>
                                    @endif
                                    @if ($canRequestCertificate)
                                        <a href="{{ route('student.request.index') }}" class="btn btn-warning btn-sm">
                                            <i class="fas fa-certificate mr-1"></i> Request Verification Letter
                                        </a>
                                    @endif
                                </div>
                            </div>
